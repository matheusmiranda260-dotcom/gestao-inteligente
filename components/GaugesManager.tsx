            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <header className="flex items-center justify-between pt-4">
                    ...
                    <button
                        ...
                        className="bg-white text-slate-600 border border-slate-300 hover:bg-slate-50 font-bold py-2 px-4 rounded-xl shadow-sm transition text-sm flex items-center gap-2"
                    >
