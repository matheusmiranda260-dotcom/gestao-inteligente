...
const StockControl: React.FC<{
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 space-y-6">
            {/* Keeping Modals ... */}
            {isAddConferenceModalOpen && <AddConferenceModal onClose={() => { setIsAddConferenceModalOpen(false); if (initialView === 'add') setPage('stock'); }} onSubmit={handleAddConferenceSubmit} stock={stock} onShowReport={setConferenceReportData} />}
            ...
            {deletingItem && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md text-center">
                        ...
                        <p className="text-lg text-slate-800 mb-6">Tem certeza que deseja excluir o lote <strong>{deletingItem.internalLot}</strong>? Esta ação não pode ser desfeita.</p>
            ...
            {releasingItem && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md text-center">
                        ...
                        <p className="text-lg text-slate-800 mb-2">Liberar Lote Manualmente?</p>
